...
namespace CMU462
{
  ...
  // FIXME: update this description once I have implemented tangent patches.
  ...
  void BezierPatch::loadControlPoints(HalfedgeIter & edge)
  {
    ...
    geometry.push_back(b00);
    geometry.push_back(b01);
    geometry.push_back(b02);
    geometry.push_back(b03);

    geometry.push_back(b10);
    geometry.push_back(b11);
    geometry.push_back(b12);
    geometry.push_back(b13);

    geometry.push_back(b20);
    geometry.push_back(b21);
    geometry.push_back(b22);
    geometry.push_back(b23);

    geometry.push_back(b30);
    geometry.push_back(b31);
    geometry.push_back(b32);
    geometry.push_back(b33);
  }
  ...
  {
    cerr << "BezierPatch:: evaluateNormal: IMPLEMENT ME!!!" << endl;
